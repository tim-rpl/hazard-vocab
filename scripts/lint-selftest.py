...
CASES = [
    ...
    ("declared-prefix",   "undeclared-generic-prefix", True, "recall — P5 clause 1; sosa: used, not declared", "sosa:"),
    ("declared-prefix",   "bound-vocabularies",  False, "precision — every prefix used is declared"),
    ("declared-prefix",   "own-namespace",       False, "precision — the project's own prefix, declared"),
